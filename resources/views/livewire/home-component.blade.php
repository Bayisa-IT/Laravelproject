...
<div>
    ...
    <ul>
        ...
        <img src="{{url('images/slider')}}/{{$slide->image}}" alt="{{$slide->title}}" data-bgposition="center center"
    ...
    <ul id="sponsors" class="tooltip-hover">
        ...
        <li data-toggle="tooltip" title="" data-original-title="{{$scategory->name}}"> 
            <a href="{{route('home.services-by-category',['category_slug'=>$scategory->slug])}}">
                <img src="{{url('images/categories')}}/{{$scategory->image}}"
                alt="{{$scategory->name}}">
            </a></li>
        @endforeach
    ...
    <img src="{{url('images/img-theme/shp.png')}}" class="img-responsive" alt="">
    </div>
    ...
    <div class="row">
    <div class="titles">
        <h2>Featured <span>Choice</span> of Services</h2>
    ...
    <a class="g-list" href="{{route('home.service_details',['service_slug'=>$service->slug])}}">
        <div class="img-hover">
            <img src="{{url('images/services/thumbnails')}}/{{$service->thumbnail}}" alt="{{$service->name}}"
        ...
        <div class="info-gallery">
            ...
            <hr class="separator">
            <p>{{$service->tagline}}</p>
            <div class="content-btn"><a href="{{route('home.service_details',['service_slug'=>$service->slug])}}l"
    ...
    <div class="col-md-8">
        <ul class="services-lines">
            ...
            <li>
                <a href="{{route('home.services-by-category',['category_slug'=>$fscategory->slug])}}">
                    <div class="item-service-line">
                        <i class="fa"><img class="icon-img"
                                src="{{url('images/categories')}}/{{$fscategory->image}}"></i>
        ...
        @foreach ($aservices as $aservice)
         <div>
                <a class="g-list" href="{{route('home.service_details',['service_slug'=>$aservice->slug])}}">
                 <div class="img-hover">
                    <img src="{{url('images/services/thumbnails')}}/{{$aservice->thumbnail}}" alt="{{$aservice->name}}" class="img-responsive">
                 </div>
                 <div class="info-gallery">
                  <hr class="separator">
