<div>
    ...
    <div class="col-sm-9">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <label for="tagline" class="control-label col-sm-3">Price:</label>
            <div class="col-sm-9">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="discount_type" class="control-label col-sm-3">Featured:</label>
                        <div class="col-sm-9">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                   ...
                   @else
                   <img src="{{url('images/services/thumbnails')}}/{{$thumbnail}}" width="60"/>
                    @endif
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        @else
                        <img src="{{url('images/services')}}/{{$image}}" width="60"/>
                        @endif
                    </div>
                    </div>
