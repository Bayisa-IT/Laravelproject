...
<head>
    ...
    <link href="{{url('css/chblue.css')}}" rel="stylesheet" media="screen">
    <link href="{{url('css/theme-responsive.css')}}" rel="stylesheet" media="screen">
    <link href="{{url('css/dtb/jquery.dataTables.min.css')}}" rel="stylesheet" media="screen">
    <link href="{{url('css/select2.min.css')}}" rel="stylesheet" media="screen">
    <link href="{{url('css/toastr.min.css')}}" rel="stylesheet" media="screen">   
...
<body>
                           ...
                           @auth
                              ...
                              <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                                <ul class="drop-down one-column hover-fade">
                                    ...
                                    <li><a href="{{route('admin.service_caegories')}}">Service Categories</a></li>
                              ...
                              @elseif(Auth::user()->utype === 'SVP')
                                    <li class="login-form"> <a href="#" title="Register">My Account (S Providers)</a>
                                        <ul class="drop-down one-column hover-fade">
                              ...
                              @else
                                    ...
                                    <li class="login-form"> <a href="#" title="Register">My Account (Customer)</a>
                                        <ul class="drop-down one-column hover-fade">
                                            <li><a href="{{route('cutomer.dashboard')}}">Dashboard</a></li>
                                            <li><a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="footer-down">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-xs-center crtext">&copy; 2021 Online Service. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>                
            </div>            
    ...
    <script type="text/javascript" src="{{url('js/nav/jquery.sticky.js')}}"></script>
    <script type="text/javascript" src="{{url('js/totop/jquery.ui.totop.js')}}"></script>
    <script type="text/javascript" src="{{url('js/accordion/accordion.js')}}"></script>
    <script type="text/javascript" src="{{url('js/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/maps/gmap3.js')}}"></script>
    <script type="text/javascript" src="{{url('js/fancybox/jquery.fancybox.js')}}"></script>
    <script type="text/javascript" src="{{url('js/carousel/carousel.js')}}"></script>
    <script type="text/javascript" src="{{url('js/filters/jquery.isotope.js')}}"></script>
    <script type="text/javascript" src="{{url('js/twitter/jquery.tweet.js')}}"></script>
    <script type="text/javascript" src="{{url('js/flickr/jflickrfeed.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/theme-options/theme-options.js')}}"></script>
    <script type="text/javascript" src="{{url('js/theme-options/jquery.cookies.js')}}"></script>
    <script type="text/javascript" src="{{url('js/bootstrap/bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/bootstrap/bootstrap-slider.js')}}"></script>
    <script type="text/javascript" src="{{url('js/dtb/jquery.dataTables.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/dtb/jquery.table2excel.js')}}"></script>
    <script type="text/javascript" src="{{url('js/dtb/script.js')}}"></script>
    <script type="text/javascript" src="{{url('js/select2.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/jquery.validate.min.js')}}"></script>
    <script type="text/javascript" src="{{url('js/validation-rule.js')}}"></script>
